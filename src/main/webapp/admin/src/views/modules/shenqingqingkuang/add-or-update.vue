<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="星级水平" prop="xingjishuiping">
          <el-input v-model="ruleForm.xingjishuiping" 
              placeholder="星级水平" clearable  :readonly="ro.xingjishuiping"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="星级水平" prop="xingjishuiping">
              <el-input v-model="ruleForm.xingjishuiping" 
                placeholder="星级水平" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
          ...
          if(o=='xingjishuiping'){
            this.ruleForm.xingjishuiping = obj[o];
	    this.ro.xingjishuiping = true;
            continue;
          }
          if(o=='shibiema'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shenqingqingkuang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shenqingqingkuangCrossAddOrUpdateFlag = false;
                  this.parent.search();
