    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="回复" prop="huifu">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.huifu" label="回复" prop="huifu">
                    <span v-html="ruleForm.huifu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.huifu = this.ruleForm.huifu.replace(reg,'../../../ssmff0vb/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
