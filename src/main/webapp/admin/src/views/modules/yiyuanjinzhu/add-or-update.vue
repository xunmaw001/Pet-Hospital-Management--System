<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.zizhizhengshu" label="资质证书" prop="zizhizhengshu">
          <file-upload
          tip="点击上传资质证书"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zizhizhengshu" label="资质证书" prop="zizhizhengshu">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zizhizhengshu.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="医疗条件" prop="yiliaotiaojian">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="医疗条件"
                  v-model="ruleForm.yiliaotiaojian" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yiliaotiaojian" label="医疗条件" prop="yiliaotiaojian">
                    <span>{{ruleForm.yiliaotiaojian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="医院介绍" prop="yiyuanjieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yiyuanjieshao" label="医院介绍" prop="yiyuanjieshao">
                    <span v-html="ruleForm.yiyuanjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yiyuanmingcheng = true;
          ...
          if(o=='yiliaotiaojian'){
            this.ruleForm.yiliaotiaojian = obj[o];
	    this.ro.yiliaotiaojian = true;
            continue;
          }
          if(o=='yingyezhizhao'){
	...
	this.ruleForm.yiyuanjieshao = this.ruleForm.yiyuanjieshao.replace(reg,'../../../ssmff0vb/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yiyuanjinzhu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yiyuanjinzhuCrossAddOrUpdateFlag = false;
                  this.parent.search();
