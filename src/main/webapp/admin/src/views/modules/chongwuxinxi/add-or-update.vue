<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="性格" prop="xingge">
          <el-input v-model="ruleForm.xingge" 
              placeholder="性格" clearable  :readonly="ro.xingge"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="性格" prop="xingge">
              <el-input v-model="ruleForm.xingge" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="喜好" prop="xihao">
          <el-input v-model="ruleForm.xihao" 
              placeholder="喜好" clearable  :readonly="ro.xihao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="喜好" prop="xihao">
              <el-input v-model="ruleForm.xihao" 
                placeholder="喜好" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
