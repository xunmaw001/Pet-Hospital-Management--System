<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="坐诊时间从" prop="zuozhenshijiancong">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.zuozhenshijiancong" 
                type="datetime"
                placeholder="坐诊时间从">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zuozhenshijiancong" label="坐诊时间从" prop="zuozhenshijiancong">
              <el-input v-model="ruleForm.zuozhenshijiancong" 
                placeholder="坐诊时间从" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yiyuanmingcheng = true;
          ...
          if(o=='zuozhenshijiancong'){
            this.ruleForm.zuozhenshijiancong = obj[o];
	    this.ro.zuozhenshijiancong = true;
            continue;
          }
          if(o=='dao'){
