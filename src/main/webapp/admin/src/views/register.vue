  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 250, 250, 0.57);borderRadius:10px">
        <h1 class="h1" style="color:rgba(81, 163, 81, 1);fontSize:28px;">宠物医院管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="识别码" class="input" v-if="tableName=='yisheng'">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.shibiema) && `yisheng` == this.tableName){
